...
#Importing Datasets
gifts <- data.frame(read_delim("C:/Users/Jatan Dewgun/Documents/School Work/Descriptive and Predictive Analytics/gifts.csv", ";", escape_double = FALSE, 
                               col_types = cols(date = col_date(format = "%d/%m/%Y")), 
                               trim_ws = TRUE))

donors <- data.frame(read_delim("C:/Users/Jatan Dewgun/Documents/School Work/Descriptive and Predictive Analytics/donors.csv", ";", escape_double = FALSE, 
                                col_types = cols(zipcode = col_character()), 
                                trim_ws = TRUE))

c2014 <- data.frame(read_delim("C:/Users/Jatan Dewgun/Documents/School Work/Descriptive and Predictive Analytics/campaign20140115.csv", ";", escape_double = FALSE, trim_ws = TRUE))

c2013 <- data.frame(read_delim("C:/Users/Jatan Dewgun/Documents/School Work/Descriptive and Predictive Analytics/campaign20130411.csv", 
...
summary(Fit)
Fit_Updated <- glm (Target~. -region_WalloonBrabant-region_EastFlanders-region_Luxembourg-region_Hainut-region_Antwerp-region_Liege-region_Namur-region_Hainut-region_FlemishBrabant-region_WestFlanders, data=smoted.data, family = 'binomial')
summary(Fit_Updated)
...
plot(Trainperf_BELC, main = 'Cumulative Gains Curve', col = 'blue', text.adj = c(-0.2,1.7))
par(new = TRUE)
